...
const getOwnedRepository = async (
  ownerId: string,
  username: string,
...
export const addRepositoryCollaborator =
  async (
    ownerId: string,
    username: string,
    repositoryName: string,
    ...
    const collaborator =
      await prisma.repositoryCollaborator.create({
        data: {
          repositoryId: repository.id,
          userId: collaboratorUser.id,
          permission,
...
export const getRepositoryCollaborators =
  async (
    ownerId: string,
    username: string,
    repositoryName: string,
  ...
  > => {
    ...
    const collaborators =
      await prisma.repositoryCollaborator.findMany({
        where: {
          repositoryId: repository.id,
        },
        orderBy: {
